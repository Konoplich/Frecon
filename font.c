...
static uint8_t scale_pixel(uint32_t neighbors, int sx, int sy, int scaling)
{
	 ...
	 *     the corner of the center pixel furthest awayfrom them, and all
	...
	if (neighbors & C) {
		return !((sx == 0 && sy == 0 &&
				((neighbors & (NE|N|NW|W|SW|S)) == (NE|S) ||
				(neighbors & (E|NE|N|NW|W|SW)) == (E|SW))) ||
			(sx == scaling - 1 && sy == 0 &&
				((neighbors & (W|NW|N|NE|E|SE)) == (W|SE) ||
				(neighbors & (NW|N|NE|E|SE|S)) == (NW|S))) ||
			(sx == 0 && sy == scaling - 1 &&
				((neighbors & (NW|N|W|SW|S|SE)) == (N|SE) ||
				(neighbors & (NW|W|SW|S|SE|E)) == (NW|E))) ||
			(sx == scaling - 1 && sy == scaling - 1 &&
				((neighbors & (N|NE|E|SE|S|SW)) == (N|SW) ||
				(neighbors & (NE|E|SE|S|SW|W)) == (NE|W))));
	} else {
