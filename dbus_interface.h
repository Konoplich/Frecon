...
static const char kPowerManagerSignalRule[] = "interface='org.chromium.PowerManager',type='signal'";
...
/* Signals generated by powerd */
static const char kInputEventSignal[] = "InputEvent";
enum InputEventType {
	INPUT_EVENT_POWER_BUTTON_DOWN = 0,
	INPUT_EVENT_POWER_BUTTON_UP = 1,
	INPUT_EVENT_LID_OPEN = 2,
	INPUT_EVENT_LID_CLOSED = 3
};
